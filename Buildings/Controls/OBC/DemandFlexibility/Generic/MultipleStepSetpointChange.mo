...
block MultipleStepSetpointChange "multiple-step setpoint change"
  ...
  CDL.Conversions.BooleanToReal booToRea(realTrue=-1*setChaDel, realFalse=
        setChaDel)
...
equation
  ...
  connect(reverseActingCon.y, booToRea.u)
    annotation (Line(points={{-78,-110},{-62,-110}}, color={255,0,255}));
  connect(uCurSet, add2.u1) annotation (Line(points={{-180,40},{-80,40},{-80,-24},
          {-22,-24}}, color={0,0,127}));
  connect(booToRea.y, add2.u2) annotation (Line(points={{-38,-110},{-30,-110},{-30,
          -36},{-22,-36}}, color={0,0,127}));
  connect(add2.y, swiEna.u1) annotation (Line(points={{2,-30},{10,-30},{10,-62},
          {18,-62}}, color={0,0,127}));
