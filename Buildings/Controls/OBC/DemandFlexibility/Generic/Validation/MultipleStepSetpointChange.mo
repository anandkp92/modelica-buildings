...
model MultipleStepSetpointChange "Multiple-step setpoint change"
  ...
  Buildings.Controls.OBC.DemandFlexibility.Generic.MultipleStepSetpointChange
                                                                            mulSteSetCha(reverseActing=false,
      setChaDel=0.5)
...
equation
  connect(TMinSet.y,mulSteSetCha. uMinSet) annotation (Line(points={{-98,-70},{-60,
  ...
  connect(TMaxSet.y,mulSteSetCha. uMaxSet) annotation (Line(points={{-98,10},{-80,
          10},{-80,28.2},{-22,28.2}}, color={0,0,127}));
  connect(mulSteSetCha.yComSet, sam.u)
