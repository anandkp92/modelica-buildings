...
model ZoneSetpointSource "Zone setpoint source"
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput TTarPreHeaSet
    annotation (Placement(transformation(extent={{100,60},{140,100}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput TTarSheHeaSet
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput TTarPreCooSet
                                         "setpoint target for precool"
    annotation (Placement(transformation(extent={{100,-40},{140,0}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput TTarSheCooSet
                                         "setpoint target for load shed"
...
equation
  ...
  connect(booToRea1.y,TDefCooSet)  annotation (Line(points={{16,-82},{120,-82}},
                           color={0,0,127}));
  connect(add1.y,TTarPreHeaSet)  annotation (Line(points={{84,80},{120,80}},
                     color={0,0,127}));
  connect(sub.y,TTarSheHeaSet)  annotation (Line(points={{82,46},{120,46}},
                     color={0,0,127}));
  connect(sub1.y,TTarPreCooSet)  annotation (Line(points={{68,-20},{120,-20}},
                           color={0,0,127}));
  connect(add2.y,TTarSheCooSet)  annotation (Line(points={{68,-46},{120,-46}},
                           color={0,0,127}));
